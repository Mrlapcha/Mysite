          ...
          <div className="col-lg-8">
            ...
            <div className="row mt-3">
              <p className="about-description">
                Hello, I'm Khemraj Lapcha, a dedicated student currently pursuing my BSc.
                ...
                and appreciation for music keeps me motivated and excited about the possibilities that lie ahead.
              </p>
            </div>
          </div>
        </div>
